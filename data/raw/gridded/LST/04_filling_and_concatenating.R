...
for files in range(1, 13):
  ...
  lst_day_filled = lst_day_filled.rio.clip(shp.geometry.buffer(.15), lst_day_filled.rio.crs)
  lst_night_filled = lst_night_filled.rio.clip(shp.geometry.buffer(.15), lst_night_filled.rio.crs)
